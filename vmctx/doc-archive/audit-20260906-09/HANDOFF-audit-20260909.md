> **Active continuation, September 9:** [Runtime/native validation](audit/continuation-20260909-green.md).
> **Regrade:** lifetime37 and retire38 full suites are both 72/78 under the
> corrected diagnostic oracle. Six cases per suite logged LAND EBUSY errors
> that the old checker missed. Earlier passing totals below are historical.
> #220 passes all 56 native controls. Patches0043/0044 pass all 11 HMM
> substrate probes and clean unload; HMM is not integrated into vmctx transport.
> lifetime37 772a45d272e2 passes Werror host/table checks, three focused guests,
> and 12 shared-snapshot mutation repeats. Full 78-case suite PASSED with clean diagnostics and counters.
> Heavier lifetime37 stress failed a stale-serve diagnostic on run3. retire38
> fixes private mapping retirement and removes generation byte substitution;
> its host/table, three focused guests and six strengthened stress runs pass.
> Original full-suite grading was 77/78; the corrected result is 72/78.
> Native capture/claim exclusion reproduces deterministically on #220;
> patch0045/#221 passes all 57 native and seven focused guest controls.
> Its full suite is running. Intel #71 has built the missing read-object
> and write-protection capabilities and is packaging; it has not booted. The original recall failure remains
> unexplained. Existing native UFFD/collapse/mremap and shared-object gaps
> remain open. NOT all-green. This notice supersedes the historical handoff.

> Current audit (September 9, 2026): the integration campaign is NOT all-green.
> Resume from [the active handoff](audit/HANDOFF-20260908.md) and
> [executor MM lifetime work](audit/executor-mm-design-20260909.md).
> The consolidated state below describes September 4 and is historical.
...
## 0b. Session 47 (2026-09-06, in progress) — the browser campaign: links2 cross-machine on the user's screen; netsurf and firefox pursued
