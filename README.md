...
behind every refuted design, [vmctx/HANDOFF.md](vmctx/HANDOFF.md) the
state to resume from plus the session ledger (27 → 49), and
[vmctx/audit/](vmctx/audit/README.md) the September-2026 architecture
audit's validation record, ownership contracts and open review items.
